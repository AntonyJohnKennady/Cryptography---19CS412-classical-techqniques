...
## OUTPUT:
```
Enter plain text  : john
41 46 39 45 
Encrypted Cipher Text : L V D
Decrypted Cipher Text : P U N
```
...
Enter the key (up to 16 characters): john
Cipher Text: LFFCCCNEJDOL
...
Enter the ciphertext: LFFCCCNEJDOL 
Enter the key: john
...
Enter the input string : my name is john

Cipher text after applying rail fence :
m aei onynm sjh
Text after decryption : my name is john
```
## RESULT:
The program is executed successfully
